...
pub const Transform = struct {
    ...
    pub fn scaleNonUniform(sx: f32, sy: f32) Transform {
        return Transform{
            .m = [9]f32{
                sx, 0.0, 0.0, // Column 0
                0.0, sy, 0.0, // Column 1
    ...
    pub fn translateScale(tx: f32, ty: f32, sx: f32, sy: f32) Transform {
        return Transform{
            .m = [9]f32{
                sx, 0.0, 0.0, // Column 0
                0.0, sy, 0.0, // Column 1
    ...
    pub fn transformPoint(self: Transform, point: Vec) Vec {
    ...
    pub fn transformVector(self: Transform, vector: Vec) Vec {
    ...
    pub fn getTranslation(self: Transform) Vec {
        return Vec{ .x = self.m[6], .y = self.m[7] };
    }

    // Set translation component
    pub fn setTranslation(self: *Transform, tx: f32, ty: f32) void {
        self.m[6] = tx;
        self.m[7] = ty;
    }

    // Apply translation
    pub fn translate(self: Transform, tx: f32, ty: f32) Transform {
        return self.multiply(translation(tx, ty));
    }

    // Apply scaling
    pub fn applyScale(self: Transform, sx: f32, sy: f32) Transform {
    ...
    pub fn print(self: Transform) void {
    ...
    pub fn toMat4(self: Transform) [16]f32 {
        return [16]f32{
            // Column 0
